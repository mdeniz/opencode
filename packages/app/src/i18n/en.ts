export const dict = {
  ...
  "settings.general.voice.testInput.running": "Listening...",
  "settings.general.voice.testInput.success.title": "Microphone test complete",
  "settings.general.voice.testInput.success.empty": "No speech was detected during the test.",
  "settings.general.voice.testInput.error.title": "Microphone test failed",
  "settings.general.voice.testInput.error.description": "Speech recognition returned: {{error}}",
