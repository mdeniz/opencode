export const dict = {
  ...
  "settings.general.voice.stt.title": "Speech to text",
  "settings.general.voice.stt.description": "Choose whether OpenCode transcribes with a local Whisper helper or remote provider APIs",
  "settings.general.voice.stt.local": "Local Whisper",
  "settings.general.voice.stt.auto": "Auto fallback",
  "settings.general.voice.stt.remote": "Remote provider",
  "settings.general.voice.style.title": "Voice response style",
  "settings.general.voice.style.description": "How strongly OpenCode should rewrite answers to sound better when read aloud",
  "settings.general.voice.style.light": "Light guidance",
  "settings.general.voice.style.strong": "Strong guidance",
  "settings.general.voice.language.title": "Transcription language",
  "settings.general.voice.language.description": "Guide Whisper toward the language you are speaking, or let it auto-detect",
  "settings.general.voice.language.auto": "Auto detect",
  "settings.general.voice.language.es": "Spanish",
  "settings.general.voice.language.en": "English",
  "settings.general.voice.model.title": "Local Whisper model",
  "settings.general.voice.model.description": "Larger models understand natural speech better, but take longer to run",
  "settings.general.voice.model.base": "Base",
  "settings.general.voice.model.small": "Small",
  "settings.general.voice.model.medium": "Medium",
  "settings.general.voice.model.large": "Large v3",
  "settings.general.voice.autoStop.title": "Auto-stop on silence",
  "settings.general.voice.autoStop.description": "Stop recording automatically after a sustained quiet period",
  "settings.general.voice.silence.title": "Silence timeout",
  "settings.general.voice.silence.description": "How long OpenCode waits before stopping a quiet recording. Short phrases usually need a longer timeout than extra microphone volume.",
  "settings.general.voice.input.title": "Microphone",
  "settings.general.voice.input.description": "Preferred microphone for voice input. Browser support varies by engine.",
  "settings.general.voice.output.title": "Speakers",
  "settings.general.voice.output.description": "Preferred speaker output for voice playback. Browser support varies by engine.",
  "settings.general.voice.device.default": "System default",
  "settings.general.voice.testInput.action": "Test mic",
  "settings.general.voice.testInput.running": "Measuring...",
  "settings.general.voice.testInput.success.title": "Microphone signal detected",
  ...
  "settings.general.voice.testOutput.running": "Playing...",
  "settings.general.voice.testOutput.sample": "This is a speaker test from OpenCode voice mode.",
  "settings.general.voice.testOutput.success.title": "Speaker test started",
  "settings.general.voice.testOutput.success.description": "You should hear the OpenCode voice test through your selected output.",
  "settings.general.voice.testOutput.error.title": "Speaker test unavailable",
  "settings.general.voice.testOutput.error.description": "This browser does not support speech synthesis playback here.",
  ...
  "toast.voice.unsupported.title": "Voice input is unavailable",
